...
public class Shader {
    ...
    public Shader(String vertPath, String fragPath) {
        ...
        if (a[0] == GL_FALSE) {
            MatHaxClient.LOG.error("Failed to compile vertex shader (" + vertPath + "): " + glGetShaderInfoLog(vert));
        ...
        if (a[0] == GL_FALSE) {
            MatHaxClient.LOG.error("Failed to compile fragment shader (" + fragPath + "): " + glGetShaderInfoLog(frag));
        ...
        if (a[0] == GL_FALSE) {
            MatHaxClient.LOG.error("Failed to link program: " + glGetProgramInfoLog(frag));
