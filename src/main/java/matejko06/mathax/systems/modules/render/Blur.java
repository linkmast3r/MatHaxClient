...
import matejko06.mathax.events.game.WindowResizedEvent;
import matejko06.mathax.events.render.RenderAfterWorldEvent;
import matejko06.mathax.gui.WidgetScreen;
import matejko06.mathax.renderer.Framebuffer;
import matejko06.mathax.renderer.GL;
import matejko06.mathax.renderer.PostProcessRenderer;
import matejko06.mathax.renderer.Shader;
...
import matejko06.mathax.bus.listeners.ConsumerListener;
...
public class Blur extends Module {
    ...
    public Blur() {
        ...
        MatHaxClient.EVENT_BUS.subscribe(new ConsumerListener<>(WindowResizedEvent.class, event -> {
            if (fbo1 != null) {
                fbo1.resize();
                fbo2.resize();
            }
        ...
        MatHaxClient.EVENT_BUS.subscribe(new ConsumerListener<>(RenderAfterWorldEvent.class, event -> onRenderAfterWorld()));
    }
