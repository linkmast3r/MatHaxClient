...
import matejko06.mathax.systems.modules.movement.elytrafly.modes.Packet;
import matejko06.mathax.systems.modules.movement.elytrafly.modes.Vanilla;
import matejko06.mathax.systems.modules.player.ChestSwap;
...
public class ElytraFly extends Module {
    ...
    protected void enableGroundListener() {
        MatHaxClient.EVENT_BUS.subscribe(staticGroundListener);
    }

    protected void disableGroundListener() {
        MatHaxClient.EVENT_BUS.unsubscribe(staticGroundListener);
    }
    ...
    protected void enableInstaDropListener() {
        MatHaxClient.EVENT_BUS.subscribe(staticInstadropListener);
    }

    protected void disableInstaDropListener() {
        MatHaxClient.EVENT_BUS.unsubscribe(staticInstadropListener);
    }
