package matejko06.mathax.systems.waypoints;
...
import matejko06.mathax.utils.files.StreamUtils;
...
public class Waypoints extends System<Waypoints> implements Iterable<Waypoint> {
    ...
    public File getFile() {
        ...
        return new File(new File(MatHaxClient.VERSION_FOLDER, "WayPoints"), Utils.getWorldName() + ".nbt");
    }
