...
public class MixinPlugin implements IMixinConfigPlugin {
    ...
    public void preApply(String targetClassName, ClassNode targetClass, String mixinClassName, IMixinInfo mixinInfo) {
        ...
        if (targetClassName.equals(gameRenderer)) {
            ...
            insns.add(new FieldInsnNode(Opcodes.GETSTATIC, "matejko06/mathax/MatHaxClient", "EVENT_BUS", "Lmatejko06/mathax/bus/IEventBus;"));
            insns.add(new VarInsnNode(Opcodes.DLOAD, targetInsn.var));
            insns.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "matejko06/mathax/events/render/GetFovEvent", "get", "(D)Lmatejko06/mathax/events/render/GetFovEvent;"));
            insns.add(new MethodInsnNode(Opcodes.INVOKEINTERFACE, "matejko06/mathax/bus/IEventBus", "post", "(Ljava/lang/Object;)Ljava/lang/Object;"));
            insns.add(new TypeInsnNode(Opcodes.CHECKCAST, "matejko06/mathax/events/render/GetFovEvent"));
            insns.add(new FieldInsnNode(Opcodes.GETFIELD, "matejko06/mathax/events/render/GetFovEvent", "fov", "D"));
