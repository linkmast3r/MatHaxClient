...
import matejko06.mathax.mixin.KeyBindingAccessor;
...
public class KeyBinds {
    private static final String CATEGORY = "MatHax Client";

    public static KeyBinding OPEN_CLICK_GUI = new KeyBinding("key.mathax.open-click-gui", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_RIGHT_SHIFT, CATEGORY);
