package matejko06.mathax.utils;
...
import matejko06.mathax.mixin.ClientPlayNetworkHandlerAccessor;
import matejko06.mathax.mixin.MinecraftClientAccessor;
import matejko06.mathax.mixin.MinecraftServerAccessor;
import matejko06.mathax.mixininterface.IMinecraftClient;
import matejko06.mathax.systems.modules.render.BetterTooltips;
import matejko06.mathax.utils.player.EChestMemory;
import matejko06.mathax.utils.render.PeekScreen;
import matejko06.mathax.utils.render.color.Color;
import matejko06.mathax.utils.world.BlockEntityIterator;
import matejko06.mathax.utils.world.WorldChunkIterator;
...
public class Utils {
    ...
    public static void addMatHaxPVPToServerList() {
        ...
        for (int i = 0; i < servers.size(); i++) {
            ...
            if (server.address.contains("pvp.mathaxclient.xyz")) {
                contains = true;
                break;
            }
        }
        ...
        if (!contains) {
            servers.add(new ServerInfo("MatHax PVP", "pvp.mathaxclient.xyz", false));
            servers.saveFile();
        }
    }
    ...
    public static boolean openContainer(ItemStack itemStack, ItemStack[] contents, boolean pause) {
        if (hasItems(itemStack) || itemStack.getItem() == Items.ENDER_CHEST) {
            ...
            if (pause) MatHaxClient.screenToOpen = new PeekScreen(itemStack, contents);
