...
public class Capes {
    ...
    private static final String CAPE_OWNERS_URL = "http://mathaxclient.xyz/API/capeowners.html";
    private static final String CAPES_URL = "http://mathaxclient.xyz/API/capes.html";
