package mathax.client.bus;

import mathax.client.bus.listeners.IListener;
import mathax.client.bus.listeners.LambdaListener;
...
public interface IEventBus {
     ...
     * @param packagePrefix Package prefix that this factory will be used for, eg "mathax.client.bus"
